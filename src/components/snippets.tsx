...
//     error: reviewError,
//     data: reviewData,
//   } = useReview(snippet.code as string,false);
...
//       <pre className="bg-gray-100 p-2 rounded text-sm mt-2">{snippet.code}</pre>

//       <p>{snippet.description ? snippet.description : ""}</p>
...
//       {isReviewing && (
//         <p className="mt-4 text-sm text-gray-400">AI is thinking...</p>
//       )}
